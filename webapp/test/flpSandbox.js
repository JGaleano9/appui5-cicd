		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo SAPUI5 ",
									"targetURL": "#cominchcapeappui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cominchcapeappui5-display": {
								"semanticObject": "cominchcapeappui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.inchcape.appui5",
									"url": sap.ui.require.toUrl("com/inchcape/appui5")
								}
							}
						}
					}
